...
libnbd 1.8.0 was released on B<XX XXXXXX 2021>.
...
in the handle for the application to use for its own purpose.
...
IPv6 numeric URIs (like C<nbd://[::1]/>) are now supported.
